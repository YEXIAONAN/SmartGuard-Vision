...
const buildStats = (stats) => [
  ...
  {
    title: 'SLA超时数',
    value: String(stats.sla_overdue_count ?? 0),
    unit: '条',
    note: `平均响应 ${stats.average_response_minutes ?? 0} 分钟`,
    tone: 'danger',
    size: 'normal',
  },
  {
    title: '平均处置时长',
    value: String(stats.average_resolution_minutes ?? 0),
    unit: '分钟',
    note: `感知记录 ${stats.vision_record_count + stats.sensor_record_count} 条`,
    tone: 'neutral',
    size: 'normal',
  },
]
